                ...
                <aside class="lg:col-span-1">
                    <div class="bg-white p-6 rounded-lg shadow-sm sticky top-20">
                        ...
                        <nav class="space-y-2">
                            ...
                            <a href="{{ route('user.listings') }}" class="block px-4 py-2 rounded-lg bg-indigo-50 text-indigo-600 transition">
                                My Listings
                            </a>
                                    ...
                                    <div class="border border-slate-200 rounded-lg overflow-hidden hover:shadow-lg transition">
                                        ...
                                        <div class="p-4">
                                            ...
                                            <div class="flex items-center justify-between mb-3">
                                                <span class="inline-block px-3 py-1 rounded-full text-xs font-medium {{ $car->status === 'active' ? 'bg-green-100 text-green-800' : 'bg-slate-100 text-slate-800' }}">
                                                    {{ ucfirst($car->status) }}
                                                </span>
