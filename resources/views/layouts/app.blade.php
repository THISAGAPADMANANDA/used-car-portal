        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="w-64 bg-gray-900 text-white hidden md:flex flex-col flex-shrink-0">
                ...
                <nav class="flex-1 mt-4 overflow-y-auto">
                    <div class="px-4 py-2 text-xs uppercase text-gray-500 font-semibold tracking-wider">User Menu</div>
                    ...
                    @if(Auth::user()->role == 1)
                        <div class="px-4 py-2 mt-6 text-xs uppercase text-gray-500 font-semibold tracking-wider">Admin Menu</div>
